...
## <a name="instant-sandbox"></a>Área restrita instantânea
...
## <a name="provision-microsoft-365-services-in-your-configurable-sandbox"></a>Provisione serviços do Microsoft 365 em sua área restrita configurável
