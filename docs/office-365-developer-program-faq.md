...
## <a name="how-does-the-office-365-developer-subscription-work"></a>Como funciona a assinatura de desenvolvedor do Office 365?  

Se você ingressar no Programa para Desenvolvedores do Office 365, você estará qualificado a obter uma assinatura gratuita de desenvolvedor do Office 365. Esta é uma assinatura especial, projetada para ser usada somente para desenvolvimento de aplicativos, e vem com 25 licenças de usuário. 

Depois de ingressar no Programa para Desenvolvedores do Office 365, você terá a opção de receber e configurar uma assinatura de desenvolvedor do Office 365. Sua assinatura é de 90 dias e pode ser renovada por mais 90 dias, desde que você a esteja usando para atividades de desenvolvimento. 

Para saber mais, consulte [Configurar uma assinatura de desenvolvedor do Office 365](office-365-developer-program-get-started.md).

## <a name="how-many-user-licenses-can-i-add-with-my-subscription"></a>Quantas licenças posso adicionar com minha assinatura?

Você pode adicionar até 25 licenças de usuário, incluindo o administrador, para fins de desenvolvimento apenas. Usar esta assinatura para qualquer objetivo que não o de desenvolvimento de aplicativos é uma violação do contrato de licença. Para saber mais sobre restrições de licenciamento, confira os [termos de uso da assinatura de desenvolvedor do Office 365](terms-and-conditions.md).
...
## <a name="what-development-activities-do-you-track"></a>Quais atividades de desenvolvimento vocês monitoram?
...
- 
  [Pesquisa da Microsoft](https://products.office.com/pt-BR/business/intelligent-search?tab=Discovery)
...
## <a name="what-account-can-i-use-to-sign-up-for-the-office-365-developer-program"></a>Qual conta posso usar para me inscrever no Programa para Desenvolvedores do Office 365?
...
## <a name="is-the-office-365-developer-program-available-in-my-language"></a>O Programa para Desenvolvedores do Office 365 está disponível em meu idioma?
...
## <a name="is-the-office-365-developer-subscription-available-in-my-language"></a>A assinatura de desenvolvedor do Office 365 está disponível em meu idioma?
